...
function Footer(props) {
  ...
  }, "1"), _react.default.createElement("ul", {
    className: "filters"
...
function Header(props) {
  return _react.default.createElement("header", {
    ...
    type: "checkbox" // onClick={(event) => this.props.toggleAll()}

  }), _react.default.createElement("label", null, "Mark all as complete"), _react.default.createElement("div", {
    className: "loader"
  }));
}
    ...
    value: function render() {
      ...
      return _react.default.createElement("li", {
        ...
        onChange: function onChange(event) {
          return _this.props.onEdit(_this.props.id, {
            checked: event.target.checked
          });
        }
      }), _react.default.createElement("label", {
        onDoubleClick: function onDoubleClick() {
          return _this.props.onEditTask(_this.props.id);
        }
      }, this.props.value), _react.default.createElement("button", {
        className: "destroy",
        onClick: function onClick() {
          return _this.props.onDestroy(_this.props.id);
        }
      })));
    }
  }]);
...
function (_React$Component2) {
  ...
  function ToDo() {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ToDo).call(this));
    _this2.state = {
      list: [{
        id: '1234',
        checked: true,
    ...
    _this2.onCreate = _this2.onCreate.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    _this2.onEdit = _this2.onEdit.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    _this2.onDestroy = _this2.onDestroy.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
  ...
  _createClass(ToDo, [{
    ...
    key: "onEditTask",
    value: function onEditTask(id) {
      console.log('editing', id);
    }
  }, {
    key: "toggleAll",
    value: function toggleAll(data) {
...
//# sourceMappingURL=/lesson_27.78399e21.map