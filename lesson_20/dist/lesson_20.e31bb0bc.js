...
function () {
  ...
  _createClass(Dom, [{
    ...
    value: function setCoordinates(coordinates) {
      ...
      this.p.innerText = "Your latitude: ".concat(coordinates.latitude, ", Your longitude: ").concat(coordinates.longitude, ", Your country: ").concat(coordinates.country_name, ", Your city: ").concat(coordinates.city, " and your IP: ").concat(coordinates.ip);
    }
  }]);
...
var location = new _location_api.default();
...
var promise = new Promise(function (resolve, reject) {
  ...
  return location.getMyLocation(resolve);
}).catch(function (err) {
