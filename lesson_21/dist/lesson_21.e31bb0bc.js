...
function () {
  ...
  _createClass(LocationApi, [{
    ...
    value: function getMyLocation(your_ip) {
      return fetch('http://api.ipstack.com/' + your_ip + '?access_key=ea06658607226dda76d14f5d1a8f8bef').then(function (res) {
        return res.json();
      });
    }
  }, {
    key: "getMyWeather",
    value: function getMyWeather(city) {
      return fetch('https://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=3c912d7dc513a632a861c7ad683a49f7').then(function (res) {
        return res.json();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Dom, [{
    ...
    value: function setWeather(weather) {
      ...
      var maxTemp = Math.floor(weather.main.temp_max - 273, 15);
      var minTemp = Math.floor(weather.main.temp_min - 273, 15);
      ...
      iconSky.src = "http://openweathermap.org/img/w/".concat(icon, ".png");
      this.cityDisplay = document.getElementById('city_name');
      this.cityDisplay.innerText = "".concat(cityName);
      this.descr = document.getElementById('description');
      this.descr.innerText = "".concat(description);
      this.tempDisplay = document.getElementById('temp');
      this.tempDisplay.innerText = "".concat(temp, " \xBAC");
      this.max = document.getElementById('max');
      this.max.innerText = "".concat(maxTemp, " \xBAC");
      this.min = document.getElementById('min');
      this.min.innerText = "".concat(minTemp, " \xBAC");
      this.lat = document.getElementById('latitude');
      this.lat.innerText = "Lat: ".concat(latitude);
      this.lon = document.getElementById('longitude');
      this.lon.innerText = "Lon: ".concat(longitude);
      this.prs = document.getElementById('pressure');
      this.prs.innerText = "Pressure: ".concat(preasure);
      this.hum = document.getElementById('humidity');
      this.hum.innerText = "Humidity: ".concat(humidity);
      this.wS = document.getElementById('windSpeed');
      this.wS.innerText = "Winds: ".concat(windSpeed);
    }
  }]);
...
var loc = new _location_api.default();
...
//# sourceMappingURL=/lesson_21.e31bb0bc.map